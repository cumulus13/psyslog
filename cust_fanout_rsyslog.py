...
CONFIGNAME = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'cust_fanout_rsyslog.ini')
...
channel.exchange_declare(exchange = 'rsyslog', exchange_type='fanout', durable=True, auto_delete=False)

result = channel.queue_declare(queue='', exclusive=True)
queue_name = result.method.queue
channel.queue_bind(exchange = 'rsyslog', queue = queue_name)
