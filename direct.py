...
class Direct(object):
    ...
    @classmethod
    def connection(self, exchange_name, hostname = '127.0.0.1', port = 5672, username = 'guest', password = 'guest', queue = ''):
        ...
        #parameters = pika.URLParameters('amqp://root:Xxxnuxer13@127.0.0.1:5672/%2F')
    ...
    @classmethod
    def main(self, exchange_name, hostname = '127.0.0.1', port = 5672, username = 'guest', password = 'guest', queue = ''):
    ...
    @classmethod
    def pub(self, message, exchange_name, hostname = '127.0.0.1', port = 5672, username = 'guest', password = 'guest', queue = ''):
