...
CONFIGNAME = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'cust_error.ini')
...
channel.exchange_declare(exchange = 'syslog_error', exchange_type='fanout', durable=True, auto_delete=False)

result = channel.queue_declare(queue='', exclusive=True)
queue_name = result.method.queue
channel.queue_bind(exchange = 'syslog_error', queue = queue_name)
